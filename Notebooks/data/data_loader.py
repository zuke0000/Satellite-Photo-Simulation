...
if __name__ == '__main__':
    ...
    ds1 = RSDataLoader(f'{os.getcwd()}\inria\inria_save\ps512_pd0_ol0\patches', f'{os.getcwd()}\inria\inria_save\ps512_pd0_ol0\list_train.txt', transforms=tsfms, n_class=2)
    for cnt, data_dict in enumerate(ds1):
        from mrs_utils import vis_utils
        if cnt > 0:
            break
        rgb, gt = data_dict['image'], data_dict['mask']
        #print(cls)
